...
#     pdf_filename = "tc_output.pdf"
#     c = canvas.Canvas(pdf_filename, pagesize=A4)
#     serial_no = 1000
#     for student in data:
#         student_data = {
#             "serials": str(serial_no),
#             # Since regNo is not in data, get it from regnos list using index
#             "rollnum": regnos[data.index(student)] if data.index(student) < len(regnos) else "--------",
#             "student_name": student.get("STUD_uGXX_NAME", "--------"),
#             "parent_name": student.get("stud_ugxx_fname", "--------"),
#             "nationality": student.get("STUD_uGXX_NATIONALITY", "--------"),
#             "religion": student.get("STUD_uGXX_RELIGION", "--------"),
#             "caste": student.get("stud_ugxx_castename", "--------"),
#             "gender": student.get("STUD_uGXX_SEX", "--------"),
#             "dob": student.get("STUD_uGXX_DOB", "--------"),
#             "admission_date": student.get("stud_ugxx_admit", "--------"),
#             "batch": student.get("batch", "--------"),
#             "partI": student.get("partI", "--------"),
...
#     try:
#         # Send PDF directly to default printer (Windows)
#         os.startfile(pdf_filename, "print")
#         messagebox.showinfo("Success", f"PDF generated and sent to printer: {pdf_filename}")
#     except Exception as e:
#         messagebox.showerror("Print Error", f"PDF generated but printing failed.\n{str(e)}")
