...
style.configure("Dark.TLabelframe", background="#e0e0e0")  # light gray
style.configure("Dark.TLabelframe.Label", background="#e0e0e0", font=("Segoe UI", 12, "bold"))
# ---------- Top Frame for Filters ----------
filters_frame = ttk.LabelFrame(root, text="Filter Students", padding=20,style="Dark.TLabelframe")
...
listbox_frame = ttk.LabelFrame(main_frame, text="Students", padding=10,style="Dark.TLabelframe")
...
deselect_btn = ttk.Button(button_frame, text="Deselect All", command=deselect_all)
deselect_btn.pack(pady=10, fill="x")
